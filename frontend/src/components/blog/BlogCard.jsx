...
export default function BlogCard({ article }) {
  ...
  return (
    <Link
      ...
      className="group block bg-white rounded-2xl border border-slate-100 shadow-card overflow-hidden hover:-translate-y-1 hover:shadow-glow transition-all duration-300"
    >
      {article.image_url && (
